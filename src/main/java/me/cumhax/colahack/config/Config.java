package me.cumhax.colahack.config;
...
import me.cumhax.colahack.util.FileUtil;
import net.minecraft.client.Minecraft;

public class Config
extends Thread {
    private static final Minecraft mc = Minecraft.getMinecraft();
    private static final File mainFolder = new File(Config.mc.gameDir + File.separator + "ColaHack.eu");
